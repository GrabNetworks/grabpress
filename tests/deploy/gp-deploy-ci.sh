...
ssh -i /home/jduquette/scripts/grabdev1 bitnami@grabpress-ci.grab-media.com "mkdir /opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/backups;cp -R /opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/grabpress /opt/bitnami/apps/wordpress/htdocs/wp-content/plugins/backups/grabpress-BACKUP"
